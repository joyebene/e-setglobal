...
const History = () => {
  return (
    <div className='h-fit lg:h-[110vh] bg-cover bg-center bg-no-repeats bg-[url("/assets/history-img.jpg")]'>
        ...
        <motion.div className='flex items-center justify-center sm:justify-start lg:justify-center lg:w-1/2' initial={{ opacity: 0, x: 50 }}
          ...
          transition={{ duration: 0.8 }}
>
          <Image src="/assets/logo2.png" width={300} height={300} alt='img' className='rounded-xl w-[230px] sm:w-[350] sm:h-[300] lg:w-[400] shadow-xl' />
         </motion.div>
