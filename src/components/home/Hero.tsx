...
const Grid: React.FC<GridProps> = ({text, url}) => {
  ...
  return (
    <motion.div
      ...
      className='flex items-center justify-center w-full bg-white/20 backdrop-blur-md rounded-xl p-2 md:p-3 shadow-2xl text-[9px] sm:text-[13px] lg:text-[18px]'
    >
      <Image src={url} width={60} height={60} alt='img' className='w-12 h-12 md:w-18 lg:w-20 lg:h-16' />
      <p>{text}</p>
    </motion.div>
  )
}
    ...
    >
      <div className='w-full h-full text-white bg-black/40 flex flex-col items-center justify-center pt-32'>
        ...
        >
          ...
          <h1 className='text-3xl md:text-5xl xl:text-6xl text-center'>
