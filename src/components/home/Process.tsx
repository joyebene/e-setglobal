    ...
    <div className="bg-white w-screen min-h-screen xl:h-[calc(100vh-6rem)]">
        <div className="flex flex-col items-center justify-center gap-10 w-full h-full py-20 md:py-0 px-6 pr-9 md:px-24 xl:px-60">
            <motion.div initial={{opacity:0, x: -100 }} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.5}} className='flex flex-col items-center justify-center gap-2 md:gap-4'>
                <p className='text-green-700'>Your Journey to Clean Energy</p>
                <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl xl:text-5xl text-gray-900 text-center">Our Seamless Solar Process</h1>
                <p className='text-center sm:text-lg mt-3 sm:mt-4'>From first contact to final installation, our streamlined process ensures a smooth and efficient transition to solar energy—customized to fit your needs and budget.</p>
            </motion.div>
